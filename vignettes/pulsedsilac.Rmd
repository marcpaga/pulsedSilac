...
- Add Protein and PeptideExperiment accessors
...
For `compareAssay()` it is necessary to separate the object into the two conditions that should be compared. The grey dash line indicates the identity line.

```{r}

compareAssay(x = wormsPE@ProteinExperiment[,1:7], 
             y = wormsPE@ProteinExperiment[, 8:14], 
             assayName = 'ratio')
